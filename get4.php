...
?>
    ...
    <br>
    <input type="number" id="quantityselect" name="quantity" min="1" value="1" max="15" style="appearance:auto; border:1px solid #000; border-radius:2px; padding:2px 4px; margin-top:7px;">
